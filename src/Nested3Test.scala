...
trait Nested3Test extends SpatialApp {
  final val inv_sqrt_2xPI = 23

  type T = Int

  @module
  def someMath(x: Int) = log_taylor(exp_taylor(x))
  ...
  def main(): Unit = {
    ...
    println("PASS: " + cksum + " (Nested3TestReuseNone)")
  }
...
object Nested3TestReuseNone extends Nested3Test {
  def body(i: Int, out1: Reg[Int], out2: Reg[Int], x0: Int, x1: Int, x2: Int, x3: Int, x4: Int, x5: Int): Unit = {
    Parallel {
...
object Nested3TestReuseSome extends Nested3Test {
  def body(i: Int, out1: Reg[Int], out2: Reg[Int], x0: Int, x1: Int, x2: Int, x3: Int, x4: Int, x5: Int): Unit = {
    Sequential {
      Pipe { out1 := BlkSchlsEqEuroNoDiv(x0, x1, x2, x3, x4, x5) }
...
object Nested3TestReuseAll extends Nested3Test {
  def body(i: Int, out1: Reg[Int], out2: Reg[Int], x0: Int, x1: Int, x2: Int, x3: Int, x4: Int, x5: Int): Unit = {
    Sequential {
      Pipe { out1 := BlkSchlsEqEuroNoDiv(x0, x1, x2, x3, x4, x5) }
