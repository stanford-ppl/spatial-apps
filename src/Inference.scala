    ...
    Accel{
      ...
      Foreach(rowspan par P1){ R =>
        ...
        Foreach(colspan par P2){ C =>
          ...
          MemReduce((0 until OUTPUT_CHANS par P5), accum_line_upcast)(INPUT_CHANS by 1 par P3){ ic =>
          ...
          // RELU
          Foreach(OUTPUT_CHANS by 1 par P6){i => accum_line(i) = max(0.to[T], accum_line_upcast(i).apply(27::12).as[T] + bias_sram(i))}
