...
//             Reduce(gradient_mag)(D by 1 par 1){i => pow(g_k(i), 2) / D}.reduce{_+_}
//             aeou
//           }
...
object HALP_handoff extends SpatialApp {  // Test Args: 30 2 256 0.05 1 0.00003 0.4
